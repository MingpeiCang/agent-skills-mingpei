...
- preferred verbs: `provide`, `enable`, `suggest`, `support`, `reveal`, `establish`, `capture`
- preferred adjectives: `important`, `general`, `robust`, `relevant`, `quantitative`, `mechanistic`, `novel`, `applicable`
- preferred adverbs: `directly`, `generally`, `readily`, `widely`, `closely`, `precisely`, `broadly`
